...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-4 left-4 right-4 z-[100] flex max-h-screen w-auto flex-col-reverse p-4 sm:left-auto sm:flex-col md:max-w-[420px] md:right-4 sticky", // Added 'sticky' class
      className
    )}
    {...props}
  />
